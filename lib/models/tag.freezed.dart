...
abstract class $TagCopyWith<$Res> {
  ...
  $Res call({String name, List<String>? version});
}
...
class _$_Tag implements _Tag {
  _$_Tag({required this.name, final List<String>? version})
      : _version = version;
...
abstract class _Tag implements Tag {
  factory _Tag({required final String name, final List<String>? version}) =
      _$_Tag;
